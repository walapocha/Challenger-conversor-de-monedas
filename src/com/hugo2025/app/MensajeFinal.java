...
public class MensajeFinal {
    ...
    ImageIcon iconP = new ImageIcon(getClass().getResource("/com/hugo2025/icons/icon-question.png"));
    ImageIcon iconE = new ImageIcon(getClass().getResource("/com/hugo2025/icons/icon-salir.png"));
